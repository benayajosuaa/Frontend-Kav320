            ...
            <div className="min-h-screen bg-[#e3e3e3] px-4 py-6 sm:px-6 sm:py-8">
                <div className="flex min-h-[calc(100vh-3rem)] items-center justify-center sm:min-h-[calc(100vh-4rem)]">
                    <div className="w-full max-w-152 rounded-3xl border border-black bg-white p-6 sm:p-8 md:p-10 lg:h-140 lg:w-150">
                        <div className="flex min-h-full flex-col items-center gap-y-5 sm:gap-y-6 lg:gap-y-7">
                            <div className="pb-4">
                                <h1 className="pb-2 text-center text-xl font-bold sm:text-2xl">halo pengunjung kamar320 !</h1>
                            </div>
                            <div className="flex w-full max-w-120 flex-col lg:w-auto lg:max-w-none">
                                <span className="pb-1 text-base sm:text-lg">
                                   Email / No Telephone
                                </span>
                                <input 
                                    className="w-full border-b border-black p-2 pl-1 pr-5 text-lg sm:text-xl lg:w-120"
                                    type="text" 
                                    placeholder="masukan email / no wa"
                                />
                            </div>
                            <div className="flex w-full max-w-120 flex-col lg:w-auto lg:max-w-none">
                                <span className="pb-1 text-base sm:text-lg">
                            ...
                            <div className="flex w-full max-w-120 justify-end lg:w-120 lg:max-w-none">
                                <span className="text-sm font-semibold sm:text-base lg:text-lg">Lupa Password ?</span>
                            </div>
                            <div>
