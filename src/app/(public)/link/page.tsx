...
const daftarLinkTambahan = [
    {nomor:1, href:"https://open.spotify.com/playlist/7yOIJrbv5TiDIQ86xIGpOT?si=0cbfbf82195d4fb6&pt=abfe377e3cfe8dc5012caa2bef274ca6", label:"irama kekinian"},
    {nomor:2, href:"https://open.spotify.com/playlist/2phDIvJt0oRhleibS7nIyY?si=e995e052d31f4ba4&pt=3ee53edf95b16bb5baac19cc5fb9f468", label:"nada relax dan nostalgia"},
    {nomor:3, href:"https://open.spotify.com/playlist/3aZQdUzn3Ur1dLdWnWtIli?si=e6fcaf9b89f34371&pt=7c39018efbf7388c8cf15526fa17932c", label:"kicauan yang galau bngt"},
]
            ...
            <div className="w-screen px-6 py-10 sm:px-8">
                <div className="mx-auto flex w-full max-w-md flex-col items-center justify-center">
                    ...
                    <div className="w-full pt-8 pb-8">
                        ...
                        <div>
                            <span>
                                <h1 className="w-full text-center font-light text-sm pt-5">yang bisa kami bagikan untukmu</h1>
                            </span>
                        </div>
                    </div>
