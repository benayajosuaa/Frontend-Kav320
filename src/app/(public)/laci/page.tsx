import Navbar from "../../../components/navbar-loker"
import Footer from "../../../components/footer-loker"
...
export default function HomePage(){
    return (
        <div className={`${quesFont.className} `}>
            <div className="fixed z-30 w-full backdrop-blur-md shadow-[0_8px_24px_rgba(255,255,255,0.08)]">
                <Navbar/>
            </div>
                    ...
                    <div className="relative w-full overflow-hidden pt-20 p-3 md:p-10 md:pt-30">
                        ...
                        <div className="relative z-20">
                            <div className="grid grid-cols-2 auto-rows-[140px] gap-1 md:auto-rows-[165px] lg:grid-cols-4 2xl:grid-cols-5">
                                <div className="col-span-2 row-span-4 md:row-span-3 lg:row-span-2 border-[#8aa0bd] border-4 bg-gray-100 p-4 md:p-5">
                                    <div className="flex h-full flex-col justify-between gap-y-6 md:gap-y-10">
                                            ...
                                            <div className="f">
                                                <div className="">
                                                    <div className={silkscreen.className}>
                                                        <div className="w-full max-w-90 border-[#7b7b7b] border-6 bg-[#3a3a3a] p-2">
                                                            <span>
                                                                <TextType 
                                                                    text={[
                                                                        "Loker Kamar 320",
                                        ...
                                        {/* row 3 */}
                                        <div className="mt-auto text-[#3b6ea8] flex w-full flex-col gap-y-2 border-t border-slate-300 pt-3 md:pt-4">
                                            <div>
